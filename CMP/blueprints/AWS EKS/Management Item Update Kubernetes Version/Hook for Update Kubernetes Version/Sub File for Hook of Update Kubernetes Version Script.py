...
from infrastructure.models import CustomField, Environment, ResourceHandler
...
def generate_options_for_kubernetes_version(**kwargs):
    ...
    """
    kubernetes_version = ["1.22", "1.21","1.20", "1.19"]
    return kubernetes_version
    
    
def update_cluster_version(client, resource, version,current_version):
    """
    :param client: eks
...
def run(resource, **kwargs):
    ...
    # eks client
    client, env = get_boto_client(rh, region, 'eks')
