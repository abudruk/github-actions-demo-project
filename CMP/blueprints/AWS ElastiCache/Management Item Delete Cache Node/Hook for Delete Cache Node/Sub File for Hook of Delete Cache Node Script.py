...
def run(job, *args, **kwargs):
    ...
    try:
        client.modify_cache_cluster(
            ...
            NumCacheNodes=resource.nodes_count-len(nodes),
            ApplyImmediately=True,
            CacheNodeIdsToRemove=nodes
        )
        ...
        return "SUCCESS", "Removed nodes successfully", f"Removed nodes successfully from {resource.cluster_name}"
