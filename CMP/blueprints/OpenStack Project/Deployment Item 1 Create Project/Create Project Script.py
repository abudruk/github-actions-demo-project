...
def create_custom_fields_as_needed():
    ...
    CustomField.objects.get_or_create(
        name='openstack_project_description',
        label='Openstack Project description',
        defaults={'type': 'STR',
                  'show_as_attribute': True
                  }
    )
...
def run(resource, **kwargs):
    ...
    # Create Project in Openstack Cluster
    set_progress('Creating Project in Openstack Cluster...')
    ...
    try:
        ...
        project_obj = oc_api.create_project(projectname, description)

        # Create Resource in Cloudbolt
        resource.name = projectname
        resource.openstack_project_name = projectname
        resource.openstack_project_description = description
        resource.openstack_project_id = project_obj['project']['id']
        resource.save()
...
class OpenstackAPI(object):
    ...
    def create_project(self, project_name, description=''):
        set_progress('Creating new project')
        """Creates the Project with specified project_name in Openstack Cluster."""
