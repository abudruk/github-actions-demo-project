...
def run(job, **kwargs):
    ...
    # This is because Standard_ZRS and Premium_LRS is not Supported for BlobStorage in Azure 
    if sku_name in ['Standard_ZRS', 'Premium_LRS']:
        kind='StorageV2' 
    ...
    command = client.storage_accounts.begin_create(
        resource_group,
        account_name,
        parameters,
    )
