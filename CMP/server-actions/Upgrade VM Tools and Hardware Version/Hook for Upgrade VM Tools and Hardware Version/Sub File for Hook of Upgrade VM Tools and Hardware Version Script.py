"""
This plugin action upgrades VM Tools and the hardware version on a vCenter VM.
"""
import sys
import time
import pyVmomi
...
if __name__ == '__main__':
    """
    This is only executed when this script is run from the command line to ease
